...
def rd_show(
    ...
    if all_zoom:
        axins = inset_axes(ax, width=2, height=2, loc=zloc, borderpad=0)
        ...
        # mark_inset(
        #     ax, axins, loc1=2, loc2=4, fc="none", ec='r', lw=2, ls=None
        # ) #ec='1.0' = top of colormap
        ax.add_patch(
            Rectangle(
                (zxmin, zymin),
                zxmax - zxmin,
...
class rdarray(np.ndarray):
    def __new__(
        ...
        if meta_obj is not None:
            obj.metadata = copy.deepcopy(getattr(meta_obj, "metadata", {}))
    ...
    def wrap(self):
        ...
        if self.geotransform:
            ...
            print(
                "Warning! No geotransform defined. Choosing a standard one!"
...
def flow_accumulation(dem, method=None, exponent=None, weights=None, in_place=False):
    ...
    ===================  ==============================  ==============================
    Tarboton             Alias for Dinf.                 `Tarboton 1997`_
    Dinf                 Alias for Tarboton.             `Tarboton 1997`_
    Quinn                Holmgren with exponent = 1.     `Quinn et al. 1991`_
    Holmgren(E)          Generalization of Quinn.        `Holmgren 1994`_
    Freeman(E)           TODO.                           `Freeman 1991`_
    FairfieldLeymarieD8  Alias for Rho8.                 `Fairfield and Leymarie 1991`_
    FairfieldLeymarieD4  Alias for Rho4.                 `Fairfield and Leymarie 1991`_
    Rho8                 Alias for FairfieldLeymarieD8.  `Fairfield and Leymarie 1991`_
    Rho4                 Alias for FairfieldLeymarieD4.  `Fairfield and Leymarie 1991`_
    OCallaghanD8         Alias for D8.                   `O'Callaghan and Mark 1984`_
    OCallaghanD4         Alias for D4.                   `O'Callaghan and Mark 1984`_
    D8                   Alias for OCallaghanD8.         `O'Callaghan and Mark 1984`_
    D4                   Alias for OCallaghanD4.         `O'Callaghan and Mark 1984`_
    ===================  ==============================  ==============================
    ...
    **Methods marked (E) require the exponent argument.**
    ...
    .. _Holmgren 1994:
       ...
       modelling in grid based elevation models.
       Hydrological Processes, 8(4), 327–334.
...
def terrain_attribute(dem, attrib, zscale=1.0):
    ...
    Method                   Reference
    =======================  ==============================
    slope_riserun            `Horn 1981`_
    slope_percentage         `Horn 1981`_
    slope_degrees            `Horn 1981`_
    slope_radians            `Horn 1981`_
    aspect                   `Horn 1981`_
    curvature                `Zevenbergen and Thorne 1987`_
    planform_curvature       `Zevenbergen and Thorne 1987`_
    profile_curvature        `Zevenbergen and Thorne 1987`_
    =======================  ==============================
